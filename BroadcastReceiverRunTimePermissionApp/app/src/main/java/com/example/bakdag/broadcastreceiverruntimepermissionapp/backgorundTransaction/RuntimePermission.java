    ...
    public void requestPermission(final String[] requestPermissions, final int requestCode){
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED){
            if (isFirst){
                ...
                builder.setTitle(getString(R.string.phonePermissionTitle));
                builder.setMessage(getString(R.string.phonePermissionSubTitle));
                ...
                builder.setPositiveButton(getString(R.string.possitiveTitle), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ActivityCompat.requestPermissions(RuntimePermission.this, requestPermissions, requestCode);
                    }
                });
